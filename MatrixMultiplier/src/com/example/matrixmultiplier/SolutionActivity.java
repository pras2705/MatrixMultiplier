...
public class SolutionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout rl = (RelativeLayout) findViewById(R.id.sol_ad_container);
		...
		InMobiInterstitial.InterstitialAdListener interstitialAdListener = new InMobiInterstitial.InterstitialAdListener() {
		 ...
		 interstitial = new InMobiInterstitial(this, 1459827822090L,interstitialAdListener );
...
private void initializeElements(){
	...
	public void goToMainActivity(View v){
		Intent i = new Intent();
		i.setClassName("com.example.matrixmultiplier", "com.example.matrixmultiplier.MainActivity");
		interstitial.load();
		startActivity(i);
	}
