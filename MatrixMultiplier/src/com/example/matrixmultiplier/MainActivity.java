...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intializeNumbers();
		InMobiSdk.init(this, "4028cba632f2db85013300695de90166");
		InMobiBanner imbanner = new InMobiBanner(this, 1458967564949L);
		//finding the layout view for the BannerAd
		RelativeLayout rl = (RelativeLayout) findViewById(R.id.ad_container);
		...
		//sizing and positioning(customizing) the ad layout
		 ...
		 rl.addView(imbanner,bannerLayoutParams );
		 imbanner.load();
	...
	public void submitSolution(View v){
		calculateProduct();
		Intent i = new Intent();
		i.setClassName("com.example.matrixmultiplier", "com.example.matrixmultiplier.SolutionActivity");
	...
	public void getNumValuesandBuildMatrices(){
		firstArray[0][0] =	(!num1.getText().toString().equals(""))?  Integer.parseInt(num1.getText().toString()): 0;
		firstArray[0][1] = (!num2.getText().toString().equals(""))?  Integer.parseInt(num2.getText().toString()):0;
		firstArray[0][2] = (!num3.getText().toString().equals(""))? Integer.parseInt(num3.getText().toString()):0;
		firstArray[1][0] = (!num4.getText().toString().equals(""))? Integer.parseInt(num4.getText().toString()):0;
		firstArray[1][1] =(!num5.getText().toString().equals(""))?  Integer.parseInt(num5.getText().toString()):0;
		firstArray[1][2] = (!num6.getText().toString().equals(""))? Integer.parseInt(num6.getText().toString()):0;
		firstArray[2][0] = (!num7.getText().toString().equals(""))? Integer.parseInt(num7.getText().toString()):0;
		firstArray[2][1] = (!num8.getText().toString().equals(""))? Integer.parseInt(num8.getText().toString()):0;
		firstArray[2][2] = (!num9.getText().toString().equals(""))? Integer.parseInt(num9.getText().toString()):0;
		secondArray[0][0] = (!num10.getText().toString().equals(""))? Integer.parseInt(num10.getText().toString()):0;
		secondArray[0][1] =(!num11.getText().toString().equals(""))?  Integer.parseInt(num11.getText().toString()):0;
		secondArray[0][2] = (!num12.getText().toString().equals(""))? Integer.parseInt(num12.getText().toString()):0;
		secondArray[1][0] = (!num13.getText().toString().equals(""))? Integer.parseInt(num13.getText().toString()):0;
		secondArray[1][1] = (!num14.getText().toString().equals(""))? Integer.parseInt(num14.getText().toString()):0;
		secondArray[1][2] = (!num15.getText().toString().equals(""))? Integer.parseInt(num15.getText().toString()):0;
		secondArray[2][0] = (!num16.getText().toString().equals(""))? Integer.parseInt(num16.getText().toString()):0;
		secondArray[2][1] =(!num17.getText().toString().equals(""))?  Integer.parseInt(num17.getText().toString()):0;
		secondArray[2][2] =(!num18.getText() .toString().equals(""))?  Integer.parseInt(num18.getText().toString()):0;
	}
